...
class ListingMessage extends Message {
	/**
...
class RetrieveIdMessage extends Message {
	private int id;
	/**
	 * TODO: How do we represent one record?
	 */

	private RetrieveIdMessage() {
		super();
		System.err.println("Unused");
	}
...
class EditIdMessage extends Message {
	private int id;
	/**
	 * TODO: How do we represent one record?
	 */
...
class DeleteIdMessage extends Message {
	private int id;
...
class ObliterateMessage extends Message {
